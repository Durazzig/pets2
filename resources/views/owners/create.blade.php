                ...
                <form action="{{ route('owners.store') }}" method="POST">
                    ...
                    <div class="form-group form-row">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="address" id="phone" class="form-control @error('phone') is-invalid @enderror">
                            @error('phone')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="form-group form-row">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="phone" id="name" class="form-control @error('name') is-invalid @enderror">
                            @error('name')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
